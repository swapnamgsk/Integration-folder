...
export default function AddRecord() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("/api/projects/addrecord", {
      method: "POST",
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 border rounded">
      <input name="projectName" placeholder="Project Name" onChange={handleChange} required className="border p-2 w-full" />
      <input name="technicianName" placeholder="Technician Name" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <input name="locations" placeholder="Location" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <input name="floorName" placeholder="Floor Name" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <select name="recordType" onChange={handleChange} className="border p-2 w-full mt-2">
        <option value="start">Start</option>
        <option value="end">End</option>
      </select>
      <input type="date" name="date" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <input type="time" name="time" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <input type="number" name="readingPressure" placeholder="Reading Pressure" onChange={handleChange} required className="border p-2 w-full mt-2" />
      <input type="text" name="image" placeholder="Image URL" onChange={handleChange} required className="border p-2 w-full mt-2" />
